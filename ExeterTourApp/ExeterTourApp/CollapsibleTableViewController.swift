    ...
    override func viewDidLoad() {
        ...
        sections = [
            ...
            Section(name: "Dormitories", items: [
                loc(name: "MAIN STREET DORMITORY",latitude: 42.9807765,longitude: -70.951625,photo: [],explain: "A boys' dorm on the north side of campus."),
                loc(name: "EWALD DORMITORY",latitude: 42.9807765,longitude: -70.951625,photo: [],explain: "A boys' residence."),
                loc(name: "DUTCH HOUSE",latitude: 42.9807765,longitude: -70.951625,photo: [],explain: "A girls' house-style dorm."),
                loc(name: "GOULD HOUSE",latitude: 42.9807765,longitude: -70.951625,photo: [],explain: "A boys' residence."),
                loc(name: "WHEELWRIGHT HALL",latitude: 42.9807765,longitude: -70.951625,photo: [],explain: "A girls' residence named after John Wheelwright, founder of the town of Exeter."),
                loc(name: "MERRILL HALL",latitude: 42.9807765,longitude: -70.951625,photo: [],explain: "Merrill Hall is a girls' residence."),
                loc(name: "LANGDELL HALL",latitude: 42.9807765,longitude: -70.951625,photo: [],explain: "A residence housing more than 30 girls, adjacent to Wetherell Dining Hall."),
                loc(name: "WILLIAMS HOUSE",latitude: 42.9807765,longitude: -70.951625,photo: [],explain: "Built in 1850, Williams House is the oldest boys residence on campus."),
                loc(name: "HOYT HALL",latitude: 42.9807765,longitude: -70.951625,photo: [],explain: "A girls' residence named for Joseph Hoyt, Professor of Mathematics from 1841-1859"),
                loc(name: "SOULE HALL",latitude: 42.9807765,longitude: -70.951625,photo: [],explain: "Named after Exeter's third principal, Gideon Soule, Soule Hall houses more than 40 male students."),
                loc(name: "ABBOT HALL",latitude: 42.9807765,longitude: -70.951625,photo: [],explain: "Named after Exeter's second principal, Benjamin Abbot. Abbot Hall is a boys' dorm."),
                loc(name: "PEABODY HALL",latitude: 42.9807765,longitude: -70.951625,photo: [],explain: "A boys' residence."),
                loc(name: "LAMONT HALL",latitude: 42.9807765,longitude: -70.951625,photo: [],explain: "A girls' residence."),
                loc(name: "69 FRONT STREET",latitude: 42.9804642,longitude: -70.9515184,photo: [],explain: "A girls' house-style dorm."),
                loc(name: "DOW HOUSE",latitude: 42.9804642,longitude: -70.9515184,photo: [],explain: "A boys' house-style dorm."),
                loc(name: "KNIGHT HOUSE",latitude: 42.9804642,longitude: -70.9515184,photo: [],explain: "A boys' residence."),
                loc(name: "DUNBAR HALL",latitude: 42.9804642,longitude: -70.9515184,photo: [],explain: "A four-story dormitory that accommodates more than 60 girls."),
                loc(name: "MCCONNELL HALL",latitude: 42.9804642,longitude: -70.9515184,photo: [],explain: "A girls' dorm facing the quad."),
                loc(name: "WEBSTER HALL",latitude: 42.9794149,longitude: -70.9516325,photo: [],explain: "A residence for boys."),
                loc(name: "AMEN HALL",latitude: 42.9794149,longitude: -70.9516325,photo: [],explain: "A recently renovated girls' residence."),
                loc(name: "CILLEY HALL",latitude: 42.9794149,longitude: -70.9516325,photo: [],explain: "A large dorm for boys."),
                loc(name: "WENTWORTH HALL",latitude: 42.9794149,longitude: -70.9516325,photo: [],explain: "A residence that houses 60 boys and sits between Love Gym and the quad."),
                loc(name: "BANCROFT HALL",latitude: 42.9794149,longitude: -70.9516325,photo: [],explain: "A girls' dorm that accommodates more than 40 students."),
